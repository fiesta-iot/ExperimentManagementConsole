(function() {
  ...
  dialogPolyfill.forceRegisterDialog = function(element) {
    if (element.showModal) {
      eu.fiesta_iot.platform.eee.console.warn('This browser already supports <dialog>, the polyfill ' +
  ...
  dialogPolyfill.registerDialog = function(element) {
    if (element.showModal) {
      eu.fiesta_iot.platform.eee.console.warn('Can\'t upgrade <dialog>: already supported', element);
    } else {
